...
test_tonos <- utf8::utf8_normalize(test_oxia)
write_lines(test_tonos, "voyant_test_files/voyant_test_grc_tonos_nfc.txt")

test_tonos <- read_lines("voyant_test_files/voyant_test_grc_tonos_nfc.txt")
...
test_tonos <- tolower(test_tonos)
test_tonos_split <- splitText(test_tonos)
write_lines(test_oxia_split, "voyant_test_files/voyant_test_grc_tonos_split.txt")
...
write_lines(test_tonos_split_nfc, "voyant_test_files/voyant_test_grc_tonos_split_nfc.txt")
